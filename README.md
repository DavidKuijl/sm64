...
1. Install prerequisites: `sudo apt install -y build-essential git binutils-mips-linux-gnu python3` if this gives an error please use `sudo apt-get update -y` first.
